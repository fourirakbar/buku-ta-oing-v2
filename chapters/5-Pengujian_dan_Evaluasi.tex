...
Lalu untuk kecepatan unduh dari \textit{client}, ujicoba dilakukan dengan mengunduh sebuah file dari platform Google Drive. Hasil dari uji coba kecepatan unduh dan juga \textit{upload} dapat dilihat pada Tabel \ref{kecepatanrequest2} dalam satuan detik.

\begin{longtable}{|p{0.2\textwidth}|p{0.2\textwidth}|p{0.2\textwidth}|}
	\caption{Kecepatan Menangai \textit{Request} Unduh} \label{kecepatanrequest2} \\
	\hline
	\textbf{Ukuran File} & \textbf{Rata-Rata Kecepatan} & \textbf{Waktu (detik)} \\ \hline
	\endfirsthead
	...
	126 MB & $\pm$ 2,1 MB & 65 \\ \hline
	247 MB & $\pm$ 2,1 MB & 133\\ \hline
	510 MB & $\pm$ 2,1 MB & 337\\ \hline
	1000 MB & $\pm$ 2,1 MB & 580 \\ \hline
